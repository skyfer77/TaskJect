(function () {
    ...
    if (localStorage.ynexrtl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "/lib/bootstrap/css/bootstrap.rtl.min.css");
            // rtlFn();
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "/lib//bootstrap/css/bootstrap.min.css");
    }
